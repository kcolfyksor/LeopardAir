...
namespace leopardair_wfa
{
    public partial class ChangeSeat : Form
    {
        ...
        Passenger targetpassenger, passengerbuy;
        AirTicket Airticket;
        string currentusername;
        double minusamt;
        public ChangeSeat(Membership Member, string currentuser, Flight FT0, Flight FT1, Flight FT2, Flight FT3, Flight FT4, Flight FT5)
        {
            memberlist = Member;
            FD[0] = FT0;
            FD[1] = FT1;
        ...
        private void btnChange_Click(object sender, EventArgs e)
        {
            ...
            {
                targetpassenger = FD[0].FindPassenger(tbxName.Text, tbxICNumber.Text);
                if (targetpassenger != null)
                {
                    MessageBox.Show("Choose your preferred seat.");
            ...
            {
                targetpassenger = FD[1].FindPassenger(tbxName.Text, tbxICNumber.Text);
                if (targetpassenger != null)
                {
                    MessageBox.Show("Choose your preferred seat.");
                    groupBox1.Enabled = true;
            ...
            {
                targetpassenger = FD[2].FindPassenger(tbxName.Text, tbxICNumber.Text);
                if (targetpassenger != null)
                {
                    MessageBox.Show("Choose your preferred seat.");
                    groupBox1.Enabled = true;
            ...
            {
                targetpassenger = FD[3].FindPassenger(tbxName.Text, tbxICNumber.Text);
                if (targetpassenger != null)
                {
                    MessageBox.Show("Choose your preferred seat.");
                    groupBox1.Enabled = true;
            ...
            {
                targetpassenger = FD[4].FindPassenger(tbxName.Text, tbxICNumber.Text);
                if (targetpassenger != null)
                {
                    MessageBox.Show("Choose your preferred seat.");
                    groupBox1.Enabled = true;
            ...
            {
                targetpassenger = FD[5].FindPassenger(tbxName.Text, tbxICNumber.Text);
                if (targetpassenger != null)
                {
                    MessageBox.Show("Choose your preferred seat.");
                    groupBox1.Enabled = true;
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            {
                if (groupBox1.Text == FD[0].Code)
                {
                    FD[0].CancelSeat(targetpassenger.PassengSeatRow, targetpassenger.PassengSeatColumn);
                    passengerbuy = new Passenger(tbxName.Text, tbxICNumber.Text);
                    ...
                    Airticket = new AirTicket(FD[0], rowcheck, columncheck, tbxName.Text, tbxICNumber.Text);
                }
                else if (groupBox1.Text == FD[1].Code)
                {

                    FD[1].CancelSeat(targetpassenger.PassengSeatRow, targetpassenger.PassengSeatColumn);
                    passengerbuy = new Passenger(tbxName.Text, tbxICNumber.Text);
                    FD[1].AddPassenger(passengerbuy);
                    FD[1].BuySeating(rowcheck, columncheck);
                    minusamt = FD[1].FlightPrice / 2;
                    memberlist.DeductPoints(currentusername, minusamt);
                    Airticket = new AirTicket(FD[1], rowcheck, columncheck, tbxName.Text, tbxICNumber.Text);
                }
                else if (groupBox1.Text == FD[2].Code)
                {
                    FD[2].CancelSeat(targetpassenger.PassengSeatRow, targetpassenger.PassengSeatColumn);
                    passengerbuy = new Passenger(tbxName.Text, tbxICNumber.Text);
                    FD[2].AddPassenger(passengerbuy);
                    FD[2].BuySeating(rowcheck, columncheck);
                    minusamt = FD[2].FlightPrice / 2;
                    memberlist.DeductPoints(currentusername, minusamt);
                    Airticket = new AirTicket(FD[2], rowcheck, columncheck, tbxName.Text, tbxICNumber.Text);
                }
                else if (groupBox1.Text == FD[3].Code)
                {
                    FD[3].CancelSeat(targetpassenger.PassengSeatRow, targetpassenger.PassengSeatColumn);
                    passengerbuy = new Passenger(tbxName.Text, tbxICNumber.Text);
                    FD[3].AddPassenger(passengerbuy);
                    FD[3].BuySeating(rowcheck, columncheck);
                    minusamt = FD[3].FlightPrice / 2;
                    memberlist.DeductPoints(currentusername, minusamt);
                    Airticket = new AirTicket(FD[3], rowcheck, columncheck, tbxName.Text, tbxICNumber.Text);
                }
                else if (groupBox1.Text == FD[4].Code)
                {
                    FD[4].CancelSeat(targetpassenger.PassengSeatRow, targetpassenger.PassengSeatColumn);
                    passengerbuy = new Passenger(tbxName.Text, tbxICNumber.Text);
                    FD[4].AddPassenger(passengerbuy);
                    FD[4].BuySeating(rowcheck, columncheck);
                    minusamt = FD[4].FlightPrice / 2;
                    memberlist.DeductPoints(currentusername, minusamt);
                    Airticket = new AirTicket(FD[4], rowcheck, columncheck, tbxName.Text, tbxICNumber.Text);
                }
                else if (groupBox1.Text == FD[5].Code)
                {
                    FD[5].CancelSeat(targetpassenger.PassengSeatRow, targetpassenger.PassengSeatColumn);
                    passengerbuy = new Passenger(tbxName.Text, tbxICNumber.Text);
                    FD[5].AddPassenger(passengerbuy);
                    FD[5].BuySeating(rowcheck, columncheck);
                    minusamt = FD[5].FlightPrice / 2;
                    memberlist.DeductPoints(currentusername, minusamt);
                    Airticket = new AirTicket(FD[5], rowcheck, columncheck, tbxName.Text, tbxICNumber.Text);
                }
                ActiveForm.Close();
                Airticket.Show();
            }
